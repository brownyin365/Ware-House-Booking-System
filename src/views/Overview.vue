            ...
            <section class="py-8 px-4">
              <div class="flex flex-wrap -mx-4">
                <div class="hidden md:block md:w-1/2 px-4">
                  <h1>Add Schedule</h1>
                  <p class="text-xl">
                    This is Page is to Add schedule or Buss for the day
                  </p>
                  <br />
                  <h1>List of Schedule</h1>
                  <p class="text-xl">
                    This is page list all the buss for the day
                  </p>
                  <br />
                  <h1>Add Booking</h1>
                  <p class="text-xl">
                    This is a page for passenger to make booking
                  </p>
                  <br />
                  <h1>List Booking</h1>
                  <p class="text-xl">View all bookings on this page</p>
                </div>
